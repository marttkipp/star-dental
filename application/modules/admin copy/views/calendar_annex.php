...
function renderCalendar()
 {
	...
	$('#calendar-all').fullCalendar({
		    ...
		    customButtons: {
		      ...
		      printButton: {
		        ...
		        click: function() {
		          ...
		          // alert(start_date);
		          window.open(config_url+'uhdc-diary/print-annex-schedule/'+start_date, '_blank');
		        }
		      },
	          nextButton: {
	                text:'next',
		    ...
		    header: {
		      ...
		      // center: 'title',
		      right: 'myCustomButton,prevButton,nextButton,printButton'
		    },
		     // date: '2018-12-13',
...
$(document).on("submit","form#add_note",function(e)
{
 ...
 // 	var formDate = $.fullCalendar.formatDate(m, 'YYYY-MM-DD');	
	var formDate = window.localStorage.getItem('date_set_old');
	 ...
	 var url = config_url+"reception/add_note/"+formDate+"/2";
       $.ajax({
       type:'POST',
       url: url,
       data:form_data,
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<select name="schedule" id="schedule" class="form-control">
											...
											<option value="d">SURGERY 4</option>
											<option value="e">SURGERY 5</option>
											<option value="f">THE DAY'S EVENT</option>
