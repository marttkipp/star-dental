	 ...
	 // alert(url);
	   ...
	   success:function(data){
	      ...
	      if(data.message == "success")
			{
				// alert(data.message);
				var toolbar = $("<div style='margin-left: 35px;'><table class='table table-bordered table-condensed' id='bottom-table'><thead><th style='width: 20%;'>NOTE</th><th style='width: 20%;'>NOTE</th><th style='width: 20%;'>NOTE</th><th style='width: 20%;'>NOTE</th><th style='width: 20%;'>NOTE</th></thead><tbody>"+data.content+"</tbody></table></div>")
				// toolbar.append($("<div/>", { "class": "fc-clear"}));
				// insert row before title.
