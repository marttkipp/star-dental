			<?php
            echo form_open("administration/reports/search_objectives", array("class" => "form-horizontal"));
            ?>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label">Objective Finding: </label>
                    	<div class="col-lg-8">
                            <select id='drug_id' name='product_id' class="form-control custom-select">
                                <option value=''>None - Please Select an objective finding</option>
                                <?php echo $objectives;?>
                            </select>
                        </div>
                    </div>
