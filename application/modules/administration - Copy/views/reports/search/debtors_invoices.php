						...
						<div class="form-group">
							...
							<div class="col-lg-12">
                            	<div class="input-group">
                                    ...
                                    <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="batch_date_from" placeholder="Batch date from" autocomplete="off">
                                </div>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-12">
                            	<div class="input-group">
                                    ...
                                    <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="batch_date_to" placeholder="Batch date to" autocomplete="off">
                                </div>
							</div>
						</div>
					</div>
