    ...
    <section class="panel panel-featured panel-featured-info">
        <header class="panel-heading">
            <h2 class="panel-title">Highest Findings <?php echo $title;?></h2>
        </header>    
...
$.ajax({
	type:'POST',
	url: config_url+"administration/charts/get_highest_objectives",
	cache:false,
	contentType: false,
	processData: false,
	dataType: "json",
		...
		$(function () {
			...
			function plotWithOptions() {
				$.plot($("#bar-chart"), [ d3 ], {
					...
					xaxis: {axisLabel: "Objective Findings", ticks: ticks},
					yaxis: {axisLabel: "Total Sales", 
