    ...
    <div class="col-md-12">
        ...
        <section class="panel panel-featured panel-featured-info">
            <header class="panel-heading">
            	 ...
            	 <a href="<?php echo site_url();?>accounting/company_financial/export_services_bills/<?php echo $department_id;?>"  class="btn btn-sm btn-success pull-right" style="margin-top:-25px;" download> Export Patients </a>
            </header>             
