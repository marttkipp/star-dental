...
<div class="row" style="margin-top: 30px;">
	<div class="col-md-6">
		<?php echo form_open("financials/budget/search_expenditure_schedule", array("class" => "form-horizontal"));?>
		<div class="col-md-6">
		...
		<div class="col-md-2">
			<?php
			$budget_year_searched = $this->session->userdata('expenditure_budget_year');

			if(!empty($budget_year_searched))
			{
				?>
				<a href="<?php echo site_url().'financials/budget/close_expenditure_schedule_search'?>" class="btn btn-sm btn-warning"> CLOSE</a>
				<?php
			}
	...
	<div class="col-md-3">
		<a href="<?php echo site_url().'company-financials/print-expenditure-schedule'?>" target="_blank" class="btn btn-sm btn-primary"> Print Schedule of Expenditure</a>		
	</div>
</div>
<div class="row">
