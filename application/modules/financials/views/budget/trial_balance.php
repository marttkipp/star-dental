		...
		<div class="col-md-8">
			<div class="row" style="margin-top: 30px;">
				<div class="col-md-12">
					...
					<div class="col-md-3">
						<a href="<?php echo site_url().'company-financials/print-trial-balance'?>" target="_blank" class="btn btn-sm btn-primary"> Print Trial Balance</a>	
					</div>
					<div class="col-md-12">
						<?php
						$budget_year_searched = $this->session->userdata('trail_budget_year');

						if(!empty($budget_year_searched))
						{
							?>
							<a href="<?php echo site_url().'financials/budget/close_trial_balance_search'?>" class="btn btn-sm btn-warning"> CLOSE</a>
							<?php
						}
