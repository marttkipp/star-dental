...
<div class="row" style="margin-top: 10px;">
	<div class="col-md-6">
		<?php echo form_open("financials/budget/search_budget", array("class" => "form-horizontal"));?>
		<div class="col-md-6">
		...
		<div class="col-md-2">
			...
			{
				?>
				<a href="<?php echo site_url().'financials/budget/close_budget_search'?>" class="btn btn-sm btn-warning"> CLOSE</a>
				<?php
			}
...
<script type="text/javascript">
	...
	function get_year_budget(budget_year)
	{
		var config_url = $('#config_url').val();
	 	var url = config_url+"financials/budget/get_year_budget/"+budget_year;
	 	// alert(url);
		$.ajax({
			type:'POST',
			url: url,
