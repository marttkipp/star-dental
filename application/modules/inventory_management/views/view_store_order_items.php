  <?php echo $this->load->view('search_inventory_orders', '', TRUE);?>
 <section class="panel">
            ...
            <div class="padd">
              ...
              <div class="center-align">
                <?php
                    ...
                    $search = $this->session->userdata('product_deduction_search');
    
                    if(!empty($search))
                    {
                        echo '
                        <a href="'.site_url().'inventory_management/close_request_deductions_search" class="btn btn-warning btn-sm ">Close Search</a>
                        ';
                    }
                ?>
              </div>
                    	...
                    	<div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                foreach ($rs9 as $rs10) :
                                    ...
                                    $parent_id = $rs10->parent_store;
                                    $category_id = $rs10->category_id;
                                    ...
                                    $product_deduction_rejected = $rs10->product_deduction_rejected;
                                   ...
                                   // $inventory_start_date = $this->inventory_management_model->get_inventory_start_date();
                                    ...
                                    $input_filed .= 
                                            '
                                            <td><a href="'.site_url().'reject-request/'.$product_deduction_id.'"  onclick="return confirm(\'Do you want to reject this request ?\')" class="btn btn-sm btn-danger fa fa-trash"></a></td>
                                            ';


                                    if($product_deduction_rejected == 1){
