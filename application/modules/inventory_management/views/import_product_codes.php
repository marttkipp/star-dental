<section class="panel">
		...
		?>
            ...
            <?php echo form_open_multipart('import/import-product_codes', array("class" => "form-horizontal", "role" => "form"));?>
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'import/import_product_codes-template';?>">here.</a></li>
                        
                        <li>Save your file as a <strong>CSV (Comma Delimited)</strong> file before importing</li>
                        <li>After adding branch data to the import template please import them using the button below</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="fileUpload btn btn-primary">
                        <span>Import Product Codes</span>
