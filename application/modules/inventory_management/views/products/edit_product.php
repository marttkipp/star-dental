<section class="panel panel-featured panel-featured-info">
    ...
    <div class="panel-body">
     <link href="<?php echo base_url()."assets/themes/jasny/css/jasny-bootstrap.css"?>" rel="stylesheet"/>
        ...
        $procurred =$this->inventory_management_model->item_proccured($inventory_start_date, $product_id,$store_id,null,null);
        ...
        if(!empty($validation_errors))
		{
            ...
            $creditor_id = set_value('creditor_id');
        ...
        ?>
     	<div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="col-lg-4 control-label">Current Stock: </label>
                    
                    <div class="col-lg-8">
                        <input type="text" class="form-control" placeholder="Current:" value="<?php echo $purchases;?>" readonly>
                    </div>
                </div>
                <div class="form-group">
