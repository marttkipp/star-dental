    ...
    <div class="col-md-12">
		<section class="panel panel-featured panel-featured-info">
		    ...
		    <div class="panel-body">
                ...
                <?php echo form_open_multipart('inventory_management/products/do_balances_import', array("class" => "form-horizontal", "role" => "form"));?>

                <div class="row">
                    <div class="col-md-12">
                        <ul>
                            <li>Download the import template <a href="<?php echo site_url().'inventory_management/products/opening_balance_import_template';?>">here.</a></li>
