                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                ...
                                <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="expiry_date" placeholder="Expiry Date" value="<?php echo set_value('expiry_date');?>">
                            </div>
                        </div>
                    </div>
