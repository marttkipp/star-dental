...
if($product_id > 0)
{
	...
	$max_reorder_level = $product[0]->max_reorder_level;
...
else
{
	...
	$max_reorder_level = set_value('max_reorder_level');
									...
									?>
                                     	<div class="row">
                                        	<div class="col-md-6">
                                                ...
                                                <div id="drug_descriptions" style="display:none;">
                                                 <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" name="product_code" placeholder="Product Code" value="<?php echo set_value('product_code');?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-4 control-label">Minimum Re order Level: </label>
                                                    
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" name="reorder_level" placeholder="Minimum Reorder Level" value="<?php echo $reorder_level;?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-4 control-label">Maximim Re order Level: </label>
                                                    
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" name="max_reorder_level" placeholder="Maximim Reorder Level" value="<?php echo $max_reorder_level;?>">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                        	<div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                    <textarea name="product_description" class="cleditor"><?php echo $product_description;?></textarea>
                                                  </div>
                                                </div>
                                        	</div>
                                        </div>
