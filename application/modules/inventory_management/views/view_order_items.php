  <?php echo $this->load->view('search_orders', '', TRUE);?>
 <section class="panel">
            ...
            <div class="padd">
              ...
              <div class="center-align">
                ...
                <?php
                    ...
                    $search = $this->session->userdata('product_order_search');
        
                        if(!empty($search))
                        {
                            echo '
                            <a href="'.site_url().'inventory_management/close_request_instanct_search" class="btn btn-warning btn-sm ">Close Search</a>
                            ';
                        }
                    	...
                    	<div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                foreach ($rs9 as $rs10) :
                                    ...
                                    // $owning_store_id = $rs10->owning_store_id;
