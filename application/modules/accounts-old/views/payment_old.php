 ...
 <section class="panel ">
	<header class="panel-heading">
		...
		<strong>Name:</strong> <?php echo $patient_surname.' '.$patient_othernames;?>. <strong> Patient Visit: </strong><?php echo $visit_type_name;?>. <a class='btn btn-sm btn-warning' data-toggle='modal' data-target='#change_patient_type' style="margin-top: -5px;"> Change Type</a>
		<strong> Account Bal: </strong> Kes <?php echo number_format($account_balance, 2);?>

		<a href="<?php echo site_url();?>administration/individual_statement/<?php echo $patient_id;?>/2" class="btn btn-sm btn-success " target="_blank" style="margin-top: -5px;"> Patient Statement</a>
			...
			<div class="col-md-12">
		        <section class="panel panel-featured panel-featured-info">
					<header class="panel-heading">
						...
						<div class="pull-right">
							<a class='btn btn-sm btn-warning' data-toggle='modal' data-target='#add_assessment' style="margin-top:-45px"><i class="fa fa-plus"></i> Add Service</a>
							<a class='btn btn-sm btn-info' data-toggle='modal' data-target='#add_provider' style="margin-top:-45px"><i class="fa fa-plus"></i> Add Provider</a>
						</div>
					</header>
					<div class="panel-body">
						<div class="row">
			            	<div class="col-md-12">
			                    <div class="col-md-4 col-sm-4">
				                  ...
				                  <!-- <label class="col-md-2 control-label">Service: </label> -->
				                  	<div class="col-md-10">
					                    <select id='service_id<?php echo $visit_id;?>' name='service_id' class='form-control custom-select ' >
				                ...
				                <div class="col-md-4 col-sm-4">
				                  ...
				                  <!-- <label class="col-md-2 control-label">Provider: </label> -->
				                  	<div class="col-md-10">
					                    <select id='provider_id<?php echo $visit_id;?>' name='provider_id' class='form-control custom-select ' >
					                ...
					                <div class="form-group">
										...
										<div class="col-lg-10">
	                                        <div class="input-group">
	                                            ...
	                                            <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="visit_date_date" id="visit_date_date<?php echo $visit_id;?>" placeholder="Admission Date" value="<?php echo date('Y-m-d');?>">
	                                        </div>
										</div>
									</div>
								</div>
				            ...
				            <div class="col-md-12" style="margin:20px;">
				            	<div class="center-align">
									<button class="btn btn-info btn-sm" type="submit" onclick="save_service_items(<?php echo $visit_id;?>)" >Add to Bill</button>
								</div>
				            </div>
					    ...
					    <div class="modal fade bs-example-modal-lg" id="add_assessment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					        <div class="modal-dialog modal-lg" role="document">
					            <div class="modal-content">
					                ...
					                <?php echo form_open("accounts/add_service_item/".$visit_id, array("class" => "form-horizontal"));?>
					    ...
					    <div class="modal fade bs-example-modal-lg" id="add_provider" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					        <div class="modal-dialog modal-lg" role="document">
					            <div class="modal-content">
					                ...
					                <div class="modal-footer">
					                	<button type="submit" class='btn btn-info btn-sm' type='submit' >Add Proovider</button>
					                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						...
						<div class="panel-body">
							    ...
							    <div class="modal fade bs-example-modal-lg" id="add_assessment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
							        <div class="modal-dialog modal-lg" role="document">
							            <div class="modal-content">
							                <div class="modal-header">
							                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							                    <h4 class="modal-title" id="myModalLabel">Add Doctors Charges</h4>
							                </div>
							                ...
							                <div class="modal-footer">
							                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
							                    <a class='btn btn-info btn-sm' type='submit' onclick=''>Add Doctor Charges</a>
							                </div>
							            </div>
							        </div>
							    </div>
                        	...
                        	<div class="row">
                            	<div class="col-md-12">
                                	...
                                	<!-- <button type="button" class="btn btn-small btn-default" data-toggle="modal" data-target="#add_assessment>"> Invoice Patient </button> -->
                                </div>
                            </div>
	    ...
	    <div class="modal fade bs-example-modal-lg" id="change_patient_type" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	        <div class="modal-dialog modal-lg" role="document">
	            <div class="modal-content">
	                ...
	                <?php echo form_open("accounts/change_patient_visit/".$visit_id, array("class" => "form-horizontal"));?>
	                <div class="modal-body">
	                	<div class="row">
	                    	<div class='col-md-12'>
	                          	<div class="form-group">
...
<script type="text/javascript">
  ...
  $(function() {
       $("#service_id<?php echo $visit_id;?>").customselect();
       $("#provider_id<?php echo $visit_id;?>").customselect();
