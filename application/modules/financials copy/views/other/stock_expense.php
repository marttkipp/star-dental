...
$balance_rs = $this->company_financial_model->get_product_expense_balance_brought_forward();
...
if($query->num_rows() > 0)
{
	...
	$result .='
					...
					';
$current_stock =  $total_cr_quantity;
$result .='
            <tr>
                  <th class="text-left"></th>
                  <th class="text-left"></th>
                  ...
                  <th class="text-center" colspan="2" style="border-top:#3c8dbc solid 2px;">'.number_format($total_cr_amount,2).'</th>
            </tr>
        ';
}
?>
