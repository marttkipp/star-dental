...
<div class="row">
	<div class="col-md-6">
		...
		<div class="form-group" style="display:none;">
			...
			<div class="col-lg-8">
				<select name="department_idddd" id="department_iddd" class="form-control" onchange="check_department_type()">
		...
		<div  id="department_type" >
			<div class="form-group">
				...
				<div class="col-lg-8">
					 <select name="personnel_id" class="form-control" id="doctor_idd" required="required">
...
<div class="center-align">
	<input type="submit" value="Initiate Visit" class="btn btn-info btn-sm" onclick="return confirm_type_of_visit()"/>
</div>
<div class="center-align">
...
<script type="text/javascript" charset="utf-8">
	...
	$(document).ready(function(){
		...
		var services_url = "<?php echo site_url();?>reception/get_services_charges/1/1";
		// alert(services_url);
...
$(document).on("change","select#visit_type_id",function(e)
{
	...
	var services_url = "<?php echo site_url();?>reception/get_services_charges/"+visit_type_id+"/1";
	// alert(services_url);
	$.get( services_url , function( data ) 
	{
...
function confirm_type_of_visit()
{
	var radioValue = $("input[name='dental_visit']:checked").val();
	var visit = '';
    if(radioValue == 0)
    {
    	visit = 'Normal Visit';
    ...
    var res = confirm('Are you sure you want to start a '+visit+' ?');
