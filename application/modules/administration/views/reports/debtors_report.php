                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div id="datetimepicker4" class="input-append">
                                        <input data-format="yyyy-MM-dd" class="form-control" type="text" name="invoice_date_from" placeholder="Batch date from" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div id="datetimepicker5" class="input-append">
                                        <input data-format="yyyy-MM-dd" class="form-control" type="text" name="invoice_date_to" placeholder="Batch date to" autocomplete="off">
                                        <span class="add-on" style="cursor:pointer;">
                                            &nbsp;<i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                            </i>
                                        </span>
