			<?php
            echo form_open("administration/reports/search_symptoms", array("class" => "form-horizontal"));
            ?>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label">Symptom: </label>
                    	<div class="col-lg-8">
                            <select id='drug_id' name='symptoms_id' class="form-control custom-select">
                                <option value=''>None - Please Select a symptom</option>
                                <?php echo $symptoms;?>
                            </select>
                        </div>
                    </div>
