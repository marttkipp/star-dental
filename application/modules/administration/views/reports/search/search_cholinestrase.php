        ...
        <section class="panel panel-featured panel-featured-info">
            <header class="panel-heading">
            	...
            	<h2 class="panel-title">Search Cholinestrase</h2>
            </header>             

          <!-- Widget content -->
                <div class="panel-body">
			<?php
            echo form_open("administration/reports/search_cholinestrase_reports", array("class" => "form-horizontal"));
            ?>
            <div class="row">
            	<div class="col-md-4">
            	...
            	<div class="col-md-12">
            		<div class="form-group">
                        <div class="center-align">
                            <button type="submit" class="btn btn-info">Search Cholinestrase Report</button>
                        </div>
                </div>
