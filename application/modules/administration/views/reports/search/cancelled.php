        <section class="panel panel-featured panel-featured-info">
          ...
          <!-- Widget content -->
			...
			<?php
            echo form_open("administration/reports/search_cancelled_reports", array("class" => "form-horizontal"));
            ?>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label">Cancelled Date From</label>
                        ...
                        <div class="col-lg-8">
                        	<div class="input-group">
                                ...
                                <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="cancelled_date_from" placeholder="Cancelled Date">
                            </div>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label class="col-lg-4 control-label">Cancelled Date To: </label>
                        ...
                        <div class="col-lg-8">
                        	<div class="input-group">
                                ...
                                <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="cancelled_date_from" placeholder="Visit Date To">
                            </div>
                        </div>
                    </div>
