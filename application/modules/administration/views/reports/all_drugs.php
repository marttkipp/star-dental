			...
			<table class="table table-hover table-bordered table-striped table-responsive col-md-12" id="customers">
				<thead>
					<tr>
						...
						<th>Visit ID</th>
						<th><a href="'.site_url().'medical-reports/drugs/visit.branch_code/'.$order_method.'">HC Seen</a></th>
						<th><a href="'.site_url().'medical-reports/drugs/staff.department_name/'.$order_method.'">Department</a></th>
						<th><a href="'.site_url().'medical-reports/drugs/service_charge.service_charge_name/'.$order_method.'">Drug</a></th>
						<th><a href="'.site_url().'medical-reports/drugs/pres.units_given/'.$order_method.'">Units</a></th>
						<th><a href="'.site_url().'medical-reports/drugs/service_charge.service_charge_amount/'.$order_method.'">Unit Cost</a></th>
						<th>Total</th>
					</tr>
				</thead>
				<tbody>
	...
	foreach($query->result() as $visit_drug_result)
	{
		...
		$drug_result .='
					<tr>
						...
						<td>'.number_format(($service_amount * $qty_given),2).'</td>
					</tr>';
	}
	$drug_result.='
				</tbody>
