                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
									<div class="input-group">
										...
										<input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="invoice_date_from" placeholder="Invoice date from" autocomplete="off">
									</div>
                                </div>
                            </div>
                    	</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
										...
										<input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="invoice_date_to" placeholder="Invoice date to" autocomplete="off">
									</div>
                                </div>
                            </div>
                    	</div>
