...
if(!empty($creditor_name))
{
    ...
    $opening_balance = set_value('opening_balance');
    $supply_category_id2 = set_value('supply_category_id');
...
else
{
    ...
    $supply_category_id2 = $row->supply_category_id;
          ...
          <section class="panel">
                <header class="panel-heading">
                    <h2 class="panel-title"><?php echo $title;?></h2>
                      ...
                      <a href="<?php echo site_url();?>procurement/suppliers" class="btn btn-sm btn-primary pull-right" style="margin-top: -25px;"><i class="fa fa-arrow-left"></i> Back to creditors</a>
                </header>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
                            <label class="col-lg-4 control-label">Supply Category </label>
                            <div class="col-lg-8">
                                <select id="supply_category_id" name="supply_category_id" class="form-control">
                                    ...
                                    {   
                                       ...
                                       if($supply_category_id2 == $supply_category_id)
                                        {
