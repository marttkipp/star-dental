  ...
  public function search_suppliers()
	{
		...
		{
			$this->session->set_userdata('search_suppliers', ' AND creditor.creditor_name LIKE \'%'.$creditor_name.'%\'');
		}
		
		redirect('procurement/suppliers');
	}
	
	public function close_search_suppliers()
	{
		$this->session->unset_userdata('search_suppliers');
