 <section class="panel">
    ...
    <div class="panel-body">
        <div class="padd">
            <?php
            echo form_open("accounting/petty_cash/search_petty_cash", array("class" => "form-horizontal"));
            ?>
            <div class="row">
            	 <input type="hidden"  data-plugin-datepicker class="form-control" name="account_id" placeholder="" value="<?php echo $account?>">
                <div class="col-md-6">
            ...
            <div class="center-align">
                <button type="submit" class="btn btn-info btn-sm">Search Petty Cash</button>
            </div>
            <?php
            echo form_close();
            ?>
