                                                ...
                                                $counter = 0;
                                                    foreach ($approvals_assiged->result() as $approvals) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo site_url().'human-resource/delete-personnel-approvals_assigned/'.$personnel_approval_id.'/'.$personnel_id; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Do you really want to delete <?php echo $inventory_level_status_name?>?');" title="Delete <?php echo $inventory_level_status_name;?>"><i class="fa fa-trash"></i></a></td>
                                                        </tr>
                                                        <?php
