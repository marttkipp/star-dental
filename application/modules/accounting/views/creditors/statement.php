                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="radio">
                                            <label>
                                                <input id="optionsRadios2" type="radio" name="transaction_type_id" value="1" checked="checked" >
                                                Invoice
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="radio">
                                            <label>
                                                <input id="optionsRadios2" type="radio" name="transaction_type_id" value="2" >
                                                Credit Note
                                            </label>
                                        </div>
                                    </div>
                              ...
                              <!--   <div class="form-group">
                                ...
                                <!-- <div class="form-group">
                                    <label class="col-md-4 control-label">Payment from which account *</label>
                                    
                                    <div class="col-md-8">
                                         <select class="form-control" name="payment_from_account_id">
