...
<?php
		...
		if ($query->num_rows() > 0)
		{
			...
			$result .= 
				'
					<table class="table table-hover table-bordered table-condensed table-striped table-responsive col-md-12">
					  <thead>
						<tr>
						  <th>#</th>
				...
				$result .= 
					'
						<tr>
							...
							<td>'.$last_visit.'</td>
							<td>'.$balance.'</td>
							<td><a href="'.site_url().'receipt-payment/'.$patient_id.'/2" class="btn btn-sm btn-success">Payments</a>
								<a href="'.site_url().'administration/individual_statement/'.$patient_id.'/1" class="btn btn-sm btn-warning" target="_blank">Statement</a></td>
						</tr> 
				';
