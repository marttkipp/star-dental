...
class Nurse_model extends CI_Model 
{
	...
	function get_visit_procedure_billed_list($v_id)
	{
		...
		$this->db->join('visit_type','visit_type.visit_type_id = visit_charge.charge_to','left');
	...
	public function get_oe_notes($visit_id)
	{
			$table = "visit_oe";
			$where = 'visit_id = '.$visit_id;
			$items = "*";
	...
	public function get_general_exam_notes($visit_id)
	{
			$table = "visit_general_exam";
			$where = 'visit_id = '.$visit_id;
			$items = "*";
			$order = "visit_general_exam_id";
	...
	function get_occlusal_exam_notes($visit_id){
		$table = "visit_occlusal_exam";
		$where = 'visit_id = '.$visit_id;
		$items = "*";
		$order = "visit_occlusal_exam_id";
	...
	function get_prescription_notes($patient_id){
		$table = "visit_prescription,visit";
		$where = 'visit.visit_id = visit_prescription.visit_id AND visit_prescription.patient_id = '.$patient_id;
		$items = "*";
		$order = "visit_prescription_id";
	...
	function get_prescription_notes_visit($visit_id){
		$table = "visit_prescription,visit";
		$where = 'visit.visit_id = visit_prescription.visit_id AND visit_prescription.visit_id = '.$visit_id;
		$items = "*";
		$order = "visit_prescription_id";
