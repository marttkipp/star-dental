...
$this->nurse_model->visit_quote_insert($visit_id,$procedure_id,$suck);
...
$visit__rs1 = $this->nurse_model->get_visit_quotation_charges($visit_id, $procedure_id);
echo "
							...
							$total= $total +($units * $visit_charge_amount);
								...
								echo"
										<tr> 
											...
											<td align='center'><input type='text' id='units".$v_procedure_id."' value='".$units."' size='3' onkeyup='calculatetotalquotation(".$visit_charge_amount.",".$v_procedure_id.", ".$procedure_id.",".$visit_id.")'/></td>
											...
											<td>
												<a class='btn btn-sm btn-primary' href='#' onclick='calculatetotalquotation(".$visit_charge_amount.",".$v_procedure_id.", ".$procedure_id.",".$visit_id.")'><i class='fa fa-pencil'></i></a>
											</td>
											<td>
