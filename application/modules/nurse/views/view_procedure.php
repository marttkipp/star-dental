			...
			foreach ($rs2 as $key1):
				...
				echo"
						<tr> 
							...
							<td align='center'>
								<input type='text' id='units".$v_procedure_id."' value='".$units."' size='3' />
							</td>
							<td align='center'><input type='text' size='5' value='".$visit_charge_amount."' id='billed_amount".$v_procedure_id."'></div></td>
