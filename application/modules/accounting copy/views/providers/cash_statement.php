    ...
    <div class="col-md-12">
        ...
        <section class="panel">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo form_open("accounting/creditors/record_provider_account/".$provider_id."/1", array("class" => "form-horizontal"));?>
            ...
            if(!empty($search))
            {
                ...
                $creditor_result = $this->creditors_model->get_provider_cash_statement($provider_id);
            ?>
