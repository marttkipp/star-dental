 <section class="panel">
    ...
    <div class="panel-body">
        <div class="padd">
            <?php
            echo form_open("accounting/petty_cash/search_expense_ledger", array("class" => "form-horizontal"));
            ?>
            <div class="row">
            	 <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select class="form-control custom-select" name="account_id" id="account_id" required="">
                                <option value="">-- Select account --</option>
                                <?php
                                $query = $this->petty_cash_model->get_expense_accounts();
