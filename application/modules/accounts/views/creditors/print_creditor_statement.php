...
if ($query->num_rows() > 0)
{
	...
	foreach ($query->result() as $row)
	{
		...
		if($transaction_type_id == 1)
		{
			...
			$code = 'PMT #'.$transaction_code.'. '.$creditor_account_description;
		}
    ...
    <body class="receipt_spacing">
      ...
      <div class="row receipt_bottom_border" >
    	...
    	<div class="row">
            ...
            $eight_months = $this->creditors_model->get_statement_value($creditor_id,$date,5);
            $over_nine_months = $this->creditors_model->get_statement_value($creditor_id,$date,6);
            $total = $this_month + $three_months + $six_months + $nine_months +  $eight_months +  $over_nine_months;
            	...
            	<table class="table table-hover table-bordered ">
					<thead>
						<tr>
						  ...
						  <th class="center-align">4 Months</th>
						  <th class="center-align">5 Months</th>
						  <th class="center-align">5 Months and Over</th>
					...
					<tbody>
						<tr>
						  ...
						  <td style="text-align:center"><strong>KES. <?php echo number_format($nine_months,2);?></strong></td>
						   <td style="text-align:center"><strong>KES. <?php echo number_format($eight_months,2);?></strong></td>
						  <td style="text-align:center"><strong>KES. <?php echo number_format($over_nine_months,2);?></strong> <td style="text-align:center"><strong>KES. <?php echo number_format($total,2);?></strong></td></td>
						</tr>
					</tbody>
				</table>
            </div>
