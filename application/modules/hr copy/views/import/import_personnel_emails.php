<section class="panel">
		...
		?>
            ...
            <?php echo form_open_multipart('import/import-personnel-emails', array("class" => "form-horizontal", "role" => "form"));?>
            
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'import/personnel-emails-template';?>">here.</a></li>
            ...
            <div class="row">
				...
				<div class="col-md-12" style="margin-top:10px">
					<div class="fileUpload btn btn-primary">
                        <span>Import Personnel Emails</span>
