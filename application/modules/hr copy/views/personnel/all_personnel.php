		...
		if ($query->num_rows() > 0)
		{
			...
			foreach ($query->result() as $row)
			{
				...
				if($personnel_status == 0)
				{
					...
					$button = '<a class="btn btn-info" href="'.site_url().'human-resource/activate-personnel/'.$personnel_id.'" onclick="return confirm(\'Do you want to activate '.$personnel_name.'?\');" title="Activate '.$personnel_name.'"><i class="fa fa-thumbs-up"></i>Activate</a>';
				}
				//create activated status display
				else if($personnel_status == 1)
				{
					$status = '<span class="label label-success">Active</span>';
					$button = '<a class="btn btn-default" href="'.site_url().'human-resource/deactivate-personnel/'.$personnel_id.'" onclick="return confirm(\'Do you want to deactivate '.$personnel_name.'?\');" title="Deactivate '.$personnel_name.'"><i class="fa fa-thumbs-down"></i>Deactivate</a>';
				}
				...
				'
					<tr>
						...
						<td><a href="'.site_url().'human-resource/edit-personnel/'.$personnel_id.'" class="btn btn-sm btn-success" title="Edit '.$personnel_name.'"><i class="fa fa-pencil"></i>Edit Personnel</a></td>
						<td>'.$button.'</td>
						<td><a href="'.site_url().'human-resource/delete-personnel/'.$personnel_id.'" class="btn btn-sm btn-danger" onclick="return confirm(\'Do you really want to delete '.$personnel_name.'?\');" title="Delete '.$personnel_name.'"><i class="fa fa-trash"> Delete</i></a></td>
					</tr> 
				';
			}
							...
							<div class="panel-body">
                            	...
                            	<div class="row" style="margin-bottom:20px;">
                                    ...
                                    <div class="col-lg-2 col-md-offset-6">
                                     ...
                                     <div class="col-lg-2">
                                    	<a href="<?php echo site_url();?>human-resource/download-personnel" class="btn btn-sm btn-success">Download Personnel</a>
                                    </div>
                                </div>
