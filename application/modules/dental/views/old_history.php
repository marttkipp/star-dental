...
<?php 
		...
		$where = 'visit.patient_id = patients.patient_id AND visit.visit_id <= '.$visit_id.' AND visit.`patient_id`='.$patient_id;
										                	...
										                	<div class="col-md-12">
											                	<div class="form-group">
											                		...
											                		<div class="col-lg-10">
																		...
																		<textarea id="general_exam'.$visit_id.'" name="general_exam'.$visit_id1.'" rows="4" cols="50" class="form-control col-md-6" >'.$general_exam.'</textarea>
																	</div>
																</div>
															</div>
														';
													...
													<div class="row">
														<div class="col-md-12">
										                	<div class="form-group">
										                		...
										                		<div class="col-lg-10">
										                			<p>(Pallour , Jaundice, Swelling , Fever , Lymphadenopathy)</p>
																	<textarea id="general_exam'.$visit_id.'" name="general_exam'.$visit_id1.'" rows="4" cols="50" class="form-control col-md-6" ></textarea>
																</div>
															</div>
														</div>
													</div><br/>';
