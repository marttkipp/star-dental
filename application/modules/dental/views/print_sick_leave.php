...
<html lang="en">
    ...
    <body class="receipt_spacing">
    	<div class="row " style="margin-bottom: 10px; padding-right: 20px; padding-left: 20px;">
        	<div class="col-xs-6 pull-left" style="padding:19px; border: 1px solid grey;">
            	<img src="<?php echo base_url().'assets/logo/'.$contacts['logo'];?>" alt="<?php echo $contacts['company_name'];?>" class="img-responsive logo" style="margin:0px !important;" />
            </div>
        	<div class="col-md-6 pull-right " style="margin:0px !important;text-align: left !important;padding:20px; border: 1px solid grey;">
            	  <strong>
      ...
      <div class="row receipt_bottom_border" >
    	...
    	<div class="row " style="margin-bottom: 10px; padding-right: 20px;padding-left: 20px;">
        	<div class="col-md-4 pull-left">
            	<div class="row">
                	<div class="col-md-12">
                    	<h4><div class="title-item">NAME:</div>
                        
                    	<?php echo $patient_surname.' '.$patient_othernames; ?></h4>
                    </div>
                </div>
        	...
        	<div class="col-md-4 pull-right">
            	<div class="row">
                	<div class="col-md-12">
                    	<h4><div class="title-item">Date:</div>
                            <?php echo $visit_date; ?></h4>
                    </div>
                </div>
