    	...
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    ...
                    <form action="<?php echo site_url("payroll/payroll/add_new_benefit");?>" method="post">
                    <tr>
                ...
                if($benefits->num_rows() > 0)
                {
                    foreach ($benefits->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-benefit/".$benefit_id);?>" method="post">
                        <tr>
                            ...
                            <td><a href="<?php echo site_url("payroll/payroll/delete-benefit/".$benefit_id);?>" onclick="return confirm('Do you want to delete <?php echo $benefit_name;?>?');" title="Delete <?php echo $benefit_name;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
    	...
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    ...
                    <form action="<?php echo site_url("payroll/payroll/add_new_allowance");?>" method="post">
                    <tr>
                ...
                if($allowances->num_rows() > 0)
                {
                    foreach ($allowances->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit_allowance/".$allowance_id);?>" method="post">
                        <tr>
							...
							?>
                            <td><button class='btn btn-success btn-xs' type='submit'><i class='fa fa-pencil'></i> Edit</button></td>
                            <td><a href="<?php echo site_url("payroll/payroll/delete_allowance/".$allowance_id);?>" onclick="return confirm('Do you want to delete <?php echo $allowance_name;?>?');" title="Delete <?php echo $allowance_name;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
