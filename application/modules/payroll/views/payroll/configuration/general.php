    	...
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    <form action="<?php echo site_url("payroll/payroll/add_new_payment");?>" method="post">
                    <tr>
                ...
                if($payments->num_rows() > 0)
                {
                    foreach ($payments->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-payment/".$payment_id);?>" method="post">
                        <tr>
                            ...
                            <td><a href="<?php echo site_url("payroll/payroll/delete-payment/".$payment_id);?>" onclick="return confirm('Do you want to delete <?php echo $payment_name;?>?');" title="Delete <?php echo $payment_name;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
            ...
            <div class="panel-body">
                ...
                if($nssf->num_rows() > 0)
                {
                    foreach ($nssf->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-nssf/".$nssf_id);?>" method="post">
                        <tr>
            ...
            <div class="panel-body">
                ...
                if($relief->num_rows() > 0)
                {
                    foreach ($relief->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-relief/".$relief_id);?>" method="post">
                        <tr>
    	...
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    ...
                    <form action="<?php echo site_url("payroll/payroll/add_new_nhif");?>" method="post">
                    <tr>
                ...
                if($nhif->num_rows() > 0)
                {
                    foreach ($nhif->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-nhif/".$nhif_id);?>" method="post">
                        <tr>
                            ...
                            <td><button class='btn btn-success btn-xs' type='submit'><i class='fa fa-pencil'></i> Edit</button></td>
                            <td><a href="<?php echo site_url("payroll/payroll/delete-nhif/".$nhif_id);?>" onclick="return confirm('Do you want to delete <?php echo $nhif_amount;?>?');" title="Delete <?php echo $nhif_amount;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
    	...
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    ...
                    <form action="<?php echo site_url("payroll/payroll/add_new_paye");?>" method="post">
                    <tr>
                ...
                if($paye->num_rows() > 0)
                {
                    foreach ($paye->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-paye/".$paye_id);?>" method="post">
                        <tr>
                            ...
                            <td><button class='btn btn-success btn-xs' type='submit'><i class='fa fa-pencil'></i> Edit</button></td>
                            <td><a href="<?php echo site_url("payroll/payroll/delete-paye/".$paye_id);?>" onclick="return confirm('Do you want to delete <?php echo $paye_amount;?>?');" title="Delete <?php echo $paye_amount;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
