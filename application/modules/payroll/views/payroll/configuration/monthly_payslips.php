		...
		$total_rows = $query->num_rows();
			if ($total_rows > 0)
			{
				...
				foreach ($query->result() as $row)
				{
					...
					if(($total_rows == 1) || ($count == ($total_rows - 1)))
					{
					...
					if($payroll_check > 0)
					{
						...
						else
						{
							//echo $result; die();
							$result .= '
							<div id="page-break" '.$one_page.'>
								<table class="table">
									<tr>
										<td>';
						}
							$result .= '
									<table class="table receipt_bottom_border" style = "center-align" '.$one_page.'>
										<tr>
											<td>
												<table class="table table-condensed">
													<tr>
														<td><strong>INSIGHT MANAGEMENT CONSULTANTS LTD.</strong></td>
													</tr>
													<tr>
									...
									';
									$result .= 
									'<table class="table table_condensed" '.$one_page.'>
										<tr>
											<th>EARNINGS</th>
										</tr>
									';
									...
									$result .='</table>';
									$result .= ' <table class="table table-condensed" '.$one_page.'>
									<tr>
										<td class="left-align">
									...
									$result .= '
										<table class="table table-condensed" '.$one_page.'>
											<tr>
