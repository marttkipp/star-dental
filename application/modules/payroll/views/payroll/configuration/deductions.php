<div class="row">
    	...
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    ...
                    <form action="<?php echo site_url("payroll/payroll/add_new_deduction");?>" method="post">
                    <tr>
                ...
                if($deductions->num_rows() > 0)
                {
                    ...
                    foreach ($deductions->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-deduction/".$deduction_id);?>" method="post">
                        <tr>
                            ...
                            <td><a href="<?php echo site_url("payroll/payroll/delete-deduction/".$deduction_id);?>" onclick="return confirm('Do you want to delete <?php echo $deduction_name;?>?');" title="Delete <?php echo $deduction_name;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
    	...
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    ...
                    <form action="<?php echo site_url("payroll/payroll/add_new_other_deduction");?>" method="post">
                    <tr>
                ...
                if($other_deductions->num_rows() > 0)
                {
                    ...
                    foreach ($other_deductions->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-other-deduction/".$other_deduction_id);?>" method="post">
                        <tr>
							...
							?>
                            <td><button class='btn btn-success btn-xs' type='submit'><i class='fa fa-pencil'></i> Edit</button></td>
                            <td><a href="<?php echo site_url("payroll/payroll/delete-other-deduction/".$other_deduction_id);?>" onclick="return confirm('Do you want to delete <?php echo $other_deduction_name;?>?');" title="Delete <?php echo $other_deduction_name;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
	...
	<div class="col-md-6">
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    <form action="<?php echo site_url("payroll/payroll/add_new_loan_scheme");?>" method="post">
                    <tr>
                ...
                if($loan_schemes->num_rows() > 0)
                {
                    foreach ($loan_schemes->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-loan-scheme/".$loan_scheme_id);?>" method="post">
                        <tr>
                            <td><input type='text' name='loan_scheme_name<?php echo $loan_scheme_id;?>' value='<?php echo $loan_scheme_name;?>' class="form-control"></td>
                            <td><button class='btn btn-success btn-xs' type='submit'><i class='fa fa-pencil'></i> Edit</button></td>
                            <td><a href="<?php echo site_url("payroll/payroll/delete-loan-scheme/".$loan_scheme_id);?>" onclick="return confirm('Do you want to delete <?php echo $loan_scheme_name;?>?');" title="Delete <?php echo $loan_scheme_name;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
	...
	<div class="col-md-6">
    	<section class="panel">
            ...
            <div class="panel-body">
            	<table class='table table-striped table-hover table-condensed'>
                    <form action="<?php echo site_url("payroll/payroll/add_new_saving");?>" method="post">
                    <tr>
                ...
                if($savings->num_rows() > 0)
                {
                    foreach ($savings->result() as $row2)
                    {
                        ...
                        ?>
                        <form action="<?php echo site_url("payroll/payroll/edit-saving/".$saving_id);?>" method="post">
                        <tr>
                            <td><input type='text' name='saving_name<?php echo $saving_id;?>' value='<?php echo $saving_name;?>' class="form-control"></td>
                            <td><button class='btn btn-success btn-xs' type='submit'><i class='fa fa-pencil'></i> Edit</button></td>
                            <td><a href="<?php echo site_url("payroll/payroll/delete-saving/".$saving_id);?>" onclick="return confirm('Do you want to delete <?php echo $saving_name;?>?');" title="Delete <?php echo $saving_name;?>"><button class='btn btn-danger btn-xs' type='button'><i class='fa fa-trash'></i> Delete</button></a></td>
                        </tr>
                        </form>
                        <?php
                    }
