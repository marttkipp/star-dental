          ...
          <section class="panel">
                ...
                <header class="panel-heading">
                	<div class="row">
		                ...
		                <div class="col-md-6">
                        	<a href="<?php echo site_url();?>payroll/salary-data" class="btn btn-sm btn-info pull-right">Back to personnel</a>
		                </div>
	                </div>
                </header>
                    ...
                    <div class="row">
                    	<div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="<?php echo site_url();?>payroll/payroll/view-payslip/<?php echo $personnel_id;?>" class="btn btn-sm btn-warning pull-right" target="_blank">View payslip</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-payments/".$personnel_id);?>" method="post">
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-benefits/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-allowances/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                            ...
                                            if($allowances->num_rows() > 0)
                                            {
                                                foreach ($allowances->result() as $row2)
                                                {
                                                    ...
                                                    <tr <?php echo $class;?>>
                                                        ...
                                                        <td><input type='text' name='personnel_allowance_amount<?php echo $allowance_id;?>' value='<?php echo $amount;?>' class="form-control" <?php if($allowance_id == 1){echo 'readonly="readonly"';}?>></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
                                            ?>
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                    	<?php if($allowance_id != 1){?>
                                                    	<button class='btn btn-success' type='submit'><i class='fa fa-pencil'></i> Edit cash benefits</button>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <div class="row">
                            	<div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-deductions/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-other-deductions/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-relief/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-loan-schemes/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                            ...
                                            if($loan_schemes->num_rows() > 0)
                                            {
                                                ...
                                                foreach ($loan_schemes->result() as $row2)
                                                {
                                                    ...
                                                    if($personnel_loan_schemes->num_rows() > 0)
													{
                                                        foreach($personnel_loan_schemes->result() as $open)
														{
                                                            ...
                                                            if($id == $loan_scheme_id)
															{
																...
																$remaining_balance = $open->remaining_balance;
																...
																$prev_payments = $this->payroll_model->get_total_loan_scheme_paid($personnel_id, $loan_scheme_id, date('Y-m-d'));
																$prev_interest = $interest * $this->payroll_model->dateDiff($sdate.' 00:00', $today.' 00:00', 'month');
																$total_loan_balance = $amount-$prev_payments-($amount - $remaining_balance);
                                                                break;
                                                            }
                                                        }
                                                    }
													...
													echo"
													<tr>
														<td>".$loan_scheme_name." - Total Repayment Amount</td>
													...
													<tr>
														<td>".$loan_scheme_name." - Remaining Balance</td>
														<td><input type='text' name='remaining_balance".$loan_scheme_id."' value='".$remaining_balance."'  class='form-control'></td>
													</tr>
													<tr>
														<td>".$loan_scheme_name." - Monthly Payment</td>
													...
													<tr>
														...
														<td><input type='text' name='balance".$loan_scheme_id."' value='".number_format(($total_loan_balance), 2)."' readonly class='form-control'></td>
													</tr>
													<!--<tr>
                                ...
                                <div class="col-md-6">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-personnel-savings/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                            ...
                            <div class="row">
                            	<div class="col-md-12">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("payroll/payroll/edit-payment-details/".$personnel_id);?>" method="post">
                                            	<div class="row">
                                                    <div class="col-md-3">
