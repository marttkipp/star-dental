<section class="panel">
		...
		?>
            ...
            <?php echo form_open_multipart('import/import-overtime', array("class" => "form-horizontal", "role" => "form"));?>
           
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'import/overtime-template';?>">here.</a></li>
                        
                        <li>Save your file as a <strong>CSV (Comma Delimited)</strong> file before importing</li>
                        <li>After adding overtime data to the import template please import them using the button below</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                	<input type="submit" class="btn btn-success" value="Import Overtime" onChange="this.form.submit();" onclick="return confirm('Do you really want to upload the selected file?')">
                </div>
            </div>
            <?php echo form_close();?>
		</div>
