				...
				foreach ($query->result() as $row)
				{
					...
					if($payroll_check > 0)
					{
						...
						else
						{
							$result .= '
							<div id="page-break">
								<table class="table" style="'.$one_page.'">
									<td>';
						}
						$result .= '
									...
									$result .='</table><table class="table table-condensed">';
									...
									if(($rs_schemes->num_rows() > 0) && ($total_scheme > 0))
									{
										foreach($rs_schemes->result() as $res)
										{
											...
											if($total_loan_scheme_amount[$loan_scheme_id] != 0)
											{
												...
												$loan_scheme_balance = $loan_scheme_borrowed - $loan_scheme_amt;
