...
if ($query->num_rows() > 0)
{
	...
	foreach ($query->result() as $row)
	{
		...
		$bank_branch_code = sprintf('"%05d', $bank_branch_code);
		
		$bank_account_number = sprintf('"%014d', $row->bank_account_number);
		$gross = 0;
	...
	$result .= '
			<tr>
				<th colspan="6" style="text-align:right;">'.number_format($total_net, 2, '.', ',').'</th>
			</tr>
	';
