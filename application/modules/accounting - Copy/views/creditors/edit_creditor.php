          ...
          <section class="panel">
                <header class="panel-heading">
                    <h2 class="panel-title"><?php echo $title;?></h2>
                      ...
                      <a href="<?php echo site_url();?>accounting/creditors" class="btn btn-sm btn-primary pull-right" style="margin-top: -25px;"><i class="fa fa-arrow-left"></i> Back to creditors</a>
                </header>
