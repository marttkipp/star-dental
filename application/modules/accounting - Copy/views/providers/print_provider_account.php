...
$creditor_result = $this->creditors_model->get_provider_statement_print($provider_id);
?>

<!DOCTYPE html>
<html lang="en">
    <head>
        <title><?php echo $contacts['company_name'];?> | Provider</title>
        <!-- For mobile content -->
    ...
    <body class="receipt_spacing">
      ...
      <div class="row receipt_bottom_border" >
    	...
    	<div class="row">
            ...
            <?php
            $date = date('Y-m-d');
            $this_month = $this->creditors_model->get_provider_statement_value($provider_id,$date,1);
            $three_months = $this->creditors_model->get_provider_statement_value($provider_id,$date,2);
            $six_months = $this->creditors_model->get_provider_statement_value($provider_id,$date,3);
            $nine_months = $this->creditors_model->get_provider_statement_value($provider_id,$date,4);
            $over_nine_months = $this->creditors_model->get_provider_statement_value($provider_id,$date,5);
