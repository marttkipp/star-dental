...
?>      <section class="panel">
            <header class="panel-heading">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url();?>accounting/creditors" class="btn btn-sm btn-primary" ><i class="fa fa-arrow-left"></i> Back to creditor bills</a>
                </div>
            </header>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <div class="input-group">
                                        ...
                                        <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="creditor_account_date" placeholder="Transaction date" id="datepicker" value="<?php echo $start_date;?>" autocomplete="off">
                                    </div>
                                </div>
                              </div>
