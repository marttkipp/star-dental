...
else
{
	...
	$lender_location = $row->lender_location;
	$lender_building = $row->lender_building;
	$lender_floor = $row->lender_floor;
	$lender_address = $row->lender_address;
	$lender_post_code = $row->lender_post_code;
	$lender_city = $row->lender_city;
	$lender_contact_person_name = $row->lender_contact_person_name;
	$lender_contact_person_onames = $row->lender_contact_person_onames;
	$lender_contact_person_phone1 = $row->lender_contact_person_phone1;
	$lender_contact_person_phone2 = $row->lender_contact_person_phone2;
	$lender_contact_person_email = $row->lender_contact_person_email;
	$lender_description = $row->lender_description;
    $opening_balance = $row->opening_balance;
    // $balance_brought_forward = $row->balance_brought_forward;
...
?>      <section class="panel">
            <header class="panel-heading">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url();?>accounting/debtors" class="btn btn-sm btn-primary" ><i class="fa fa-arrow-left"></i> Back to lender bills</a>
                </div>
            </header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                	<input type="text" class="form-control" name="lender_contact_person_phone1" placeholder="Contact Phone 1" value="<?php echo $lender_contact_person_phone1;?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                	<input type="text" class="form-control" name="lender_contact_person_phone2" placeholder="Contact Phone 2" value="<?php echo $lender_contact_person_phone2;?>">
                                </div>
                            </div>
                    ...
                    <div class="row" style="margin-top:10px;">
                    	<div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                	<textarea class="form-control" name="lender_description" rows="5"><?php echo $lender_description;?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
