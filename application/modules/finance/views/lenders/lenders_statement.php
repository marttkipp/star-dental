    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <div class="widget-tools pull-right">
                <a href="<?php echo site_url();?>finance/add-lender" class="btn btn-sm btn-primary" ><i class="fa fa-plus"></i> Add lender</a>
            </div>
        </header>
        <div class="panel-body">
              ...
              <div class="row" style="margin-bottom:20px;">
                <?php echo form_open("search-lender-invoices", array("class" => "form-horizontal", "role" => "form"));?>
                    <div class="row">
                      <div class="col-md-12">
                            <div class="col-md-8">
...
?>
<?php
$lender_id = $lease_id = $this->session->userdata('invoice_lender_id_searched');
if($lender_id > 0)
{
  ...
  $bills = $this->lenders_model->get_lender_account($lender_id);
  ...
  <section class="panel">
      <header class="panel-heading">
          ...
          <div class="pull-right">
             <a href="<?php echo site_url().'lender-statement/'.$lender_id?>" style="margin-top:-40px;" class="btn btn-sm btn-warning "> Back to lender statement </a>
          </div>
      </header>
      <div class="panel-body">

        <?php echo form_open("finance/lenders/add_invoice_item/".$lender_id, array("class" => "form-horizontal"));?>
      ...
      <?php echo form_open("finance/lenders/confirm_invoice_note/".$lender_id, array("class" => "form-horizontal"));?>
      <?php
      $invoice_where = 'lender_invoice_item.lender_id = '.$lender_id.' AND lender_invoice_item_status = 0 AND account.account_id = lender_invoice_item.account_to_id';
      ...
      if($invoice_query->num_rows() > 0)
      {
        ...
        foreach ($invoice_query->result() as $key => $value) {
          ...
          $result_payment .= '<tr>
                                  ...
                                  <td><a href="'.site_url().'delete-lender-invoice-item/'.$lender_invoice_item_id.'/'.$lender_id.'" type="submit" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i></a></td>
                              </tr>';
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <table class="table table-hover table-bordered col-md-12">
              ...
              <tbody>
                <?php
                	// $lender_invoices = $this->lenders_model->get_lender_invoice($lease_id,10);
                ...
                if($lender_invoices->num_rows() > 0)
                {
                  ...
                  foreach ($lender_invoices->result() as $key) {
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo site_url().'lender-invoice/edit-lender-invoice/'.$lender_invoice_id;?>" class="btn btn-sm btn-success" ><i class="fa fa-pencil"></i></a></td>
                      <td><a href="<?php echo site_url().'lender-invoice/delete-lender-invoice/'.$lender_invoice_id;?>" class="btn btn-sm btn-danger" onclick="return confirm('Do you want to delete this invoice ?')"><i class="fa fa-trash"></i></a></td>
