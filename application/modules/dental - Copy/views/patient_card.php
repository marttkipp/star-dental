...
?>
 <section class="panel panel-<?php echo $color?>">
	<header class="panel-heading">
		...
		<div class="pull-right">
			...
			{
				?>
			 	<a href="<?php echo site_url().'preauths'?>" style="margin-top:-50px" class="btn btn-sm btn-info fa fa-arrow-left" > Back to Preauths </a>
			 	<?php
			}
			else
			{
				?>
		 			<a href="<?php echo site_url().'queue'?>" style="margin-top:-50px" class="btn btn-sm btn-info fa fa-arrow-left" > Back to Queue </a>
				<?php
			}
			?>
		</div>
