			...
			<?php
					...
					if ($query->num_rows() > 0)
					{
						...
						foreach ($query->result() as $row)
						{
							...
							else
							{
								...
								$todays_new_notes .= '
													...
													<div class="row">
									                	<div class="col-md-12">
										                	<div class="form-group">
										                		<label class="col-lg-2 control-label">PD Hx / PM Hx: </label>
										                		<div class="col-lg-8">
							...
							$get_oe_done = $this->nurse_model->get_oe_notes($visit_id1);
							$rsoe_num_rows = count($get_oe_done);
							//echo $rsoe_num_rows;

							if($rsoe_num_rows > 0){
								foreach ($get_oe_done as $key6) :
									$oral_examination = $key6->oe_description;
								endforeach;

								$notes .= '<p><span class="bold">Oral Examination : </span> '.$oral_examination.'</p>';
								$todays_new_notes .= '<br/>
													<div class="row">
														<div class="col-md-12">
															<div class="form-group">
