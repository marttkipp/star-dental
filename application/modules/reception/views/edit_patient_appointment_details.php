		...
		<div class="form-group">
			...
			<div class="col-lg-8">
                <div class="input-group">
                    ...
                    <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="visit_date" placeholder="Visit Date" value="<?php echo $appointment_date;?>" id="txtdate2">
                </div>
			</div>
		</div>
		<div class="form-group">
            ...
            <div class="col-lg-8">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" data-plugin-timepicker="" id="timepicker" name="time_start" value="<?php echo $time_in_12_hour_format?>">
                </div>
            </div>
        </div>
		<div class="form-group">
