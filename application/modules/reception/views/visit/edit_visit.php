...
$scheme_name = $row->insurance_description;
...
?>		
		...
		<section class="panel">
            <header class="panel-heading">
                ...
                <a href="<?php echo site_url();?>patients" class="btn btn-info btn-sm pull-right" style="margin-top: -25px;">  <i class="fa fa-arrow-left"></i> Patients list</a>
            </header>
		        <!-- Widget content -->
