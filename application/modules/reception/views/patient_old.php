...
<section class="panel">
    <header class="panel-heading">
		...
		echo '
			...
			<a href="'.site_url().'add-patient" class="btn btn-success btn-sm pull-right">Add Patient</a>
			';
		...
		if ($query->num_rows() > 0)
		{
			...
			foreach ($query->result() as $row)
			{
				...
				{
					$result .=form_open("reception/save_inpatient_visit/".$patient_id, array("class" => "form-horizontal"));
					...
					'
						<tr>
							...
							<td>
								<input type="hidden" name="visit_date'.$patient_id.'" class="form-control" value="'.date('Y-m-d').'">
								<select name="visit_type_id'.$patient_id.'" id="visit_type_id2'.$patient_id.'" class="form-control" >
								...
								<div id="insured_company2'.$patient_id.'" style="display: none;margin-top:5px;">
                                    <div class="form-group" style="margin-bottom: 15px;">
										<label class="col-lg-4 control-label">Company: </label>
										<div class="col-lg-8">
											<input type="text" name="insurance_description'.$patient_id.'" class="form-control">
										</div>
									</div>
									<div class="form-group" style="margin-bottom: 15px;">
										<label class="col-lg-4 control-label">Number: </label>
										<div class="col-lg-8">
											<input type="text" name="insurance_number'.$patient_id.'" class="form-control">
										</div>
									</div>
									...
									<div class="form-group" style="margin-bottom: 15px;">
										...
										<div class="col-lg-8">
											<input type="number" name="insurance_limit'.$patient_id.'" class="form-control">
										</div>
									</div>
							...
							<td> <select name="room_id'.$patient_id.'" class="form-control">
							...
							<td><button type="submit" class="btn btn-sm btn-info">Queue Patient</button></td>
