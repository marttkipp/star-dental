...
{	
	...
	*/
	...
	public function get_all_departments_account($table, $where, $per_page, $page, $order = 'department_account_id', $order_method = 'ASC')
	{
		//retrieve all users
		$this->db->from($table);
		$this->db->select('*');
	...
	*/
	...
	public function add_account_to_department($department_id)
	{
		# code..
		...
		if($this->db->insert('department_account', $data))
		{
			return TRUE;
		}
		else{
