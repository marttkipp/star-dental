<div class="row" style="margin-top:10px;">
	<div class="col-md-12">
		<div class="pull-right">
		 <a href="<?php echo site_url()?>hospital-administration/department-accounts" class="btn btn-sm btn-primary"> Back to Department accounts </a>
            ...
            <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal'));?>
                 <div class="row">
                    ...
                    <div class="col-md-5">
                     ...
                     <div class="col-md-5">
                        <div class="form-group">
                            <label class="col-lg-4 control-label"> Accounts: </label>
                    ...
                    <div class="col-md-2">
                        <div class="center-align">
                          <button type="submit" class="btn btn-info"> Add department account</button>
                        </div>
                    </div>
                </div>
            	<?php echo form_close(); ?>
