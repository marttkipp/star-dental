			...
			foreach ($query->result() as $row)
			{
				...
				'
					<tr>
						...
						<td><a href="'.site_url().'hospital-administration/department-accounts/'.$department_id.'" class="btn btn-sm btn-success" title="Edit '.$department_name.'"><i class="fa fa-plus"></i> Department Accounts</a></td>
						<td>'.$button.'</td>
