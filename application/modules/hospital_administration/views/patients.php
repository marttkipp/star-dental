<section class="panel">
		...
		?>
            ...
            <?php echo form_open_multipart('hospital-administration/import-patients-data-values', array("class" => "form-horizontal", "role" => "form"));?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'hospital-administration/import-patients-data-template';?>">here.</a></li>
