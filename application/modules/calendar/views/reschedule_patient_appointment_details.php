...
<div class="row">
	...
	<form id="reschedule_appointment" method="post">
		<div class="col-md-12">		
			...
			<div class="form-group">
				...
				<div class="col-lg-8">
	                <div class="input-group">
	                    ...
	                    <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control datepicker" name="visit_date" placeholder="Visit Date" value="<?php echo $appointment_date;?>" id="txtdate2">
	                </div>
				</div>
			</div>
			<div class="form-group">
						...
						<?php		
							...
							if($doctos->num_rows() > 0)
							{
								foreach ($doctos->result() as $key => $value4) {
									...
									{
										echo  '<option value="'.$personnel_id.'" selected="selected">'.$personnel_fname.'</option>';
									}
									else
									{
			...
			<input type="hidden" name="reschedule_id" id="reschedule_id" value="1">
			<input type="hidden" name="patient_phone1" id="patient_phone1" value="<?php echo $patient_phone1;?>">
			<input type="hidden" name="visit_id" id="visit_id" value="<?php echo $visit_id;?>">
			<input type="hidden" name="patient_surname" id="patient_surname" value="<?php echo $patient_surname;?>">
			<input type="hidden" name="appointment_start_time" id="appointment_start_time" value="<?php echo $appointment_start_time;?>">
		...
		<div class="row" >
	        <div class="col-md-12">
	        	<div class=" center-align" style="margin-top: 10px;">
	        		<button type="submit" class="btn btn-sm btn-success ">RESCHEDULE APPOINTMENT</button>
