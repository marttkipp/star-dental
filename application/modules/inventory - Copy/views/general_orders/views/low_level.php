						...
						// {	
							...
							'
								<tr>
									...
									<td>'.$store_name.'</td>
									<td>'.$created_by.'</td>
									<td><a href="'.site_url().'inventory/add-general-order-item/'.$order_id.'/'.$order_number.'" class="btn btn-success  btn-sm fa fa-folder"> Order Items</a></td>

									<td><a href="'.site_url().'inventory/print-general-order/'.$order_id.'" class="btn btn-warning  btn-sm fa fa-print" target="_blank"> Print Order Item</a></td>
