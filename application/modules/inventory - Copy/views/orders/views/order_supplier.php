...
$supplier_order_details = $this->orders_model->get_supplier_order_details($order_id,$supplier_id);
// var_dump($supplier_order_details);die();
...
<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title pull-left"><?php echo $creditor_name;?></h2>
    		...
    		<div class="col-md-12">
    			...
    			<div class="col-md-6">
    				...
    				<div class="form-group">
    					<label class="col-lg-5 control-label"><strong>Order Items :</strong> </label>
    					<div class="col-lg-7">
			            	<a class="btn btn-primary btn-sm col-md-12 fa fa-print" href="<?php echo base_url();?>inventory/generate-rfq/<?php echo $order_id;?>/<?php echo $creditor_id;?>/<?php echo $order_number;?>" target="_blank"> Generate Request for quotation </a>
			            </div>
    				</div>
