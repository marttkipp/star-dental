...
$supplier_order_details = $this->orders_model->get_supplier_order_details($supplier_order_id,$creditor_id);
...
<html lang="en">
    ...
    <body class="receipt_spacing">
      ...
      <div class="row receipt_bottom_border" >
        	...
        	<div class="row">
	        	<div class="col-md-7 pull-left">
	            	<div class="row">
	                	<div class="col-md-10">
	                		<div class="col-md-6">
		                		<strong>Supplier :</strong> <?php echo $creditor_name;?><br>
		                		<strong>Phone :</strong> <?php echo $creditor_phone;?><br>
		                		<strong>Email :</strong>  <?php echo $creditor_email;?><br>
		                	</div>
	                    </div>
	                </div>
    	...
    	<div class="row receipt_bottom_border">
        	<div class="col-md-12">
            	Please supply the following goods/services to ALEXANDRIA CANCER CENTRE on or before <strong> <?php echo date('jS F Y',strtotime(date("Y-m-d"))); ?> </strong>  and submit the invoice without delay
            </div>
        </div>
        	...
        	<div class="col-md-12">
            				<table class="table table-hover table-bordered table-striped col-md-12">
                                ...
                                <tbody>
                                	...
                                	{
                                		foreach ($items_rs->result() as $key) {
                                			# code...
                                			$order_id = $key->order_id;
											$product_name = $key->product_name;
											$order_item_id = $key->order_item_id;
											$order_item_quantity = $key->supplying;
											$supplier_unit_price = $key->single_price;
