...
if($supplier_details->num_rows() > 0)
{
	foreach ($supplier_details->result() as $key_supplier) {
		...
		$supplier_name = $key_supplier->creditor_name;
		$supplier_contact_person = $key_supplier->creditor_contact_person_name;
		$supplier_phone = $key_supplier->creditor_phone;
		$supplier_email = $key_supplier->creditor_email;
		$supplier_physical_address = '';//$key_supplier->creditor_physical_address;
	}
}
