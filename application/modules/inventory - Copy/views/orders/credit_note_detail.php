...
{
	$title = 'Credit note items for '.$store_name.' Ref No '.$reference_number.'';
}
else
{
	$title = 'Goods Returned Note items for '.$store_name.' Ref No '.$order_number.'';
}
				...
				<div class="col-md-4">
					...
					?>
						<?php echo form_open("update-note-date/".$order_id, array("class" => "form-horizontal"));?>
				            ...
				            ?>
					            <div class="form-group">
									<label class="col-lg-4 control-label">Credit Note No#: </label>
								  
									<div class="col-lg-8">
					            		<input type="text" class="form-control" name="supplier_invoice_number" placeholder="Credit Note Number" value="<?php echo $supplier_invoice_number;?>">
					            	</div>
					            </div>
					            <div class="form-group">
    ...
    <header class="panel-heading">
        <h2 class="panel-title pull-left"><?php echo $title;?></h2>
         <div class="widget-icons pull-right">
				...
				{
         		?>
         		<!-- <a href="<?php echo base_url();?>goods-received-notes/<?php echo $order_id;?>" target="_blank" class="btn btn-success btn-sm"><i class=""></i> Goods Received Notes</a> -->
         		<?php

         		}
         		?>
         		<!-- <a href="<?php echo base_url();?>supplier-statement/<?php echo $creditor_id_value;?>" target="_blank" class="btn btn-warning btn-sm"><i class=""></i> Supplier Statement</a> -->
         		<?php
         		if($order_approval_status != 7)
				{
         		?>
		...
		<div class="col-md-12">
			...
			<?php
				...
				if ($order_approval_status == 0 )
				{
					...
					{
						?>
							<a href="<?php echo base_url();?>print-suppliers-credit-note/<?php echo $order_id?>" target="_blank" class="btn btn-info  btn-sm "> PRINT CREDIT NOTE </a>
					...
					{
						?>
						<a href="<?php echo base_url();?>print-suppliers-credit-note/<?php echo $order_id?>" target="_blank" class="btn btn-info  btn-sm "> PRINT INVOICE </a>
						<a class="btn btn-success btn-sm" href="<?php echo base_url();?>inventory/finish-returned-note/<?php echo $order_id;?>" onclick="return confirm('Do you want to close the goods returned note ? ')" >CLOSE RETURNED NOTES</a>
						<?php
					}
				}
				else if($order_approval_status == 7 AND $personnel_id == 0)
				{
					...
					if($deduction_type_id == 0)
					{
						?>
						<a href="<?php echo base_url();?>print-suppliers-credit-note/<?php echo $order_id?>" target="_blank" class="btn btn-info  btn-sm "> PRINT INVOICE </a>
							<a class="btn btn-danger btn-sm" href="<?php echo base_url();?>inventory/open-supplier-credit-note/<?php echo $order_id;?>/1" onclick="return confirm('Do you want to open procurement ? ')" >OPEN CREDIT NOTE</a>
						<?php
					}
					else
					{
						?>
						<a class="btn btn-danger btn-sm" href="<?php echo base_url();?>inventory/open-supplier-credit-note/<?php echo $order_id;?>/1" onclick="return confirm('Do you want to open procurement ? ')" >OPEN GOODS RETURNED NOTE</a>
