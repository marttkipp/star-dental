  <?php echo $this->load->view('search_transfered_products', '', TRUE);?>
...
<section class="panel panel-featured panel-featured-info">
    ...
    <div class="panel-body">
		...
		<?php
			...
			if(!empty($search))
			{
				$search_result = '<a href="'.site_url().'inventory/orders/close_transfer_order_search" class="btn btn-danger">Close Search</a>';
			}
								...
								// {	
									...
									'
										<tr>
											...
											<td>'.$created_by.'</td>
											<td>'.$status.'</td>
											<td><a href="'.site_url().'procurement/order-invoice-detail/'.$order_id.'" class="btn btn-info  btn-sm fa fa-eye"> VIEW ORDER </a></td>
											<td><a href="'.base_url().'goods-transfered-notes/'.$order_id.'" target="_blank" class="btn btn-warning btn-sm"><i class="fa fa-print"></i> PRINT </a></td>
