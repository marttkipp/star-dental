																...
																foreach ($creditor_items->result() as $creditoritems){
																		...
																		$expiry_date = $creditoritems->expiry_date;
																		  ...
																		  if($vat > 0)
																		 {
																			...
																			$vat_capture = (0.16 *$current_price) / 1.16;
    ...
    <body class="receipt_spacing">
      ...
      <div class="row receipt_bottom_border" >
        	<div class="col-md-12 center-align">
        		<?php
        		if($deduction_type_id == 1)
        		{
        			?>
            	<h4><strong>GOODS RETURNED NOTE  <?php echo $order_number;?></strong></h4>
        			<?php
        		}
        		else
        		{
        			?>
            		<h4><strong>CREDIT NOTE FOR INVOICE <?php echo $invoice_number;?></strong></h4>
        			<?php
        		}
        		?>
